...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{Imagen8.png}
        \caption{Simulación del circuito pasa-banda RC.}
        \label{fig:circuito-pasa-banda}
    \end{figure}

\begin{figure}[H]
		\centering
		\includegraphics[width=0.9\linewidth]{Imagen9.png}
		\caption{Curva de magnitud del filtro pasabanda RC.}
		\label{fig:curva-pasa-banda}
\end{figure}
...
\begin{itemize}
	...
	\item Se explicó el comportamiento de los filtros RC como integradores o derivadores en los límites de frecuencia, y se mostró cómo combinar ambos para formar un filtro pasabanda.
\end{itemize}
